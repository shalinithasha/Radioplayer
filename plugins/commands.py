...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player Bot** \nමට Channels සහ Groups වල 24x7 නොනවතින Radio/Stream Music වාදනය කළ හැක. Made with ❤️ By Shalini!"
HELP = """🏷️ **Need Help?** 🤔
...
async def start(client, message):
    ...
    [
        InlineKeyboardButton('MORE BOTS', url='https://t.me/shalinibot'),
