"""
Pfizer v1, Telegram Voice Chat Bot
Copyright (C) 2021  Asm Safone <https://t.me/shalinibots>
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "replay":
        ...
        if not start_time:
            await query.edit_message_text(f"{emoji.PLAY_BUTTON} **මොකුත් play වෙන්නේ නැ!**")
            return
